...
(function(){
  ...
  function showOutput(output,fileName) {
    ...
    figCaption.innerHTML = '<em class="output__size">Output size: ' + fileSize(output) + '</em><textarea id = "svg" contentEditable="true"  class="output__raw" style="width:200px; height:100px;">' + output.replace(/</g,'&lt;').replace(/>/g,'&gt;') + '</textarea>';
